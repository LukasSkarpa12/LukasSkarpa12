...
<div align="center">
    <a href="./README-CZ.md"><img src="https://img.shields.io/badge/README-CZ-blue?color=eba0ac&labelColor=eba0ac&style=for-the-badge"></a>
...
const LukasSkarpa12 = {
    ...
    languagesSpoken: {
        english: "Cambridge B2 Certified",
        czech: "Rodilý mluvčí"
    }
};
```
...
- **Lokalita:** Pitín, Zlínský kraj, Česká republika
...
| **Backend** | Python |
| **Nástroje** | Git, Jira, Confluence |
| **Jazyky** | Čeština (rodilý mluvčí), Angličtina (B2 certifikát) |
